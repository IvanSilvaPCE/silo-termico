            ...
            <b-table-simple responsive bordered>
               ...
               <b-tbody>
                  <b-tr>
                     ...
                     <b-td class="text-center"><b-icon :icon="this.parametros.HHO == 1 ? 'check' : 'x'" scale="2" :variant="this.parametros.HHO == 1 ? 'success' : 'danger'"></b-icon></b-td>
                     <b-td class="text-center"><b-icon :icon="this.parametros.HHO == 1 ? 'check' : 'x'" scale="2" :variant="this.parametros.HHO == 1 ? 'success' : 'danger'"></b-icon></b-td>
                     <b-td class="text-center"><b-icon :icon="this.parametros.HHO == 1 ? 'check' : 'x'" scale="2" :variant="this.parametros.HHO == 1 ? 'success' : 'danger'"></b-icon></b-td>
                     <b-td class="text-center"><b-icon :icon="this.parametros.HHO == 1 ? 'check' : 'x'" scale="2" :variant="this.parametros.HHO == 1 ? 'success' : 'danger'"></b-icon></b-td>
                     <b-td class="text-center"><b-icon :icon="this.parametros.HHO == 1 ? 'check' : 'x'" scale="2" :variant="this.parametros.HHO == 1 ? 'success' : 'danger'"></b-icon></b-td>
                  ...
                  <b-tr>
                     ...
                     <b-td class="text-center"><b-icon :icon="this.parametros.HHD == 1 ? 'check' : 'x'" scale="2" :variant="this.parametros.HHD == 1 ? 'success' : 'danger'"></b-icon></b-td>
                     <b-td class="text-center"><b-icon :icon="this.parametros.HHD == 1 ? 'check' : 'x'" scale="2" :variant="this.parametros.HHD == 1 ? 'success' : 'danger'"></b-icon></b-td>
                     <b-td class="text-center"><b-icon :icon="this.parametros.HHD == 1 ? 'check' : 'x'" scale="2" :variant="this.parametros.HHD == 1 ? 'success' : 'danger'"></b-icon></b-td>
                     <b-td class="text-center"><b-icon :icon="this.parametros.HHD == 1 ? 'check' : 'x'" scale="2" :variant="this.parametros.HHD == 1 ? 'success' : 'danger'"></b-icon></b-td>
                     <b-td class="text-center"><b-icon :icon="this.parametros.HHD == 1 ? 'check' : 'x'" scale="2" :variant="this.parametros.HHD == 1 ? 'success' : 'danger'"></b-icon></b-td>
...
export default {
   ...
   methods: {
      ...
      async buscarParametros() {
         ...
         const dados = await client.get(`/armazem/buscarparametros/${this.idArmazem}?celula=${this.celula}`).catch((err) => {
