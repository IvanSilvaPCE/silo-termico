         ...
         <div class="heading1 margin_0">
            <b-row>
               ...
               <b-col cols="2" class="text-right">
                  ...
                  <b-button variant="outline-primary" size="sm" v-b-tooltip.hover title="Ver log de eventos" @click="verLog(idSecador)"><b-icon-clock></b-icon-clock></b-button>
               </b-col>
            </b-row>
         </div>
      </div>
...
export default {
   ...
   methods: {
      async buscar() {
         ...
         const dados = await client.get(`/secador/buscaralarme/${this.idSecador}?dia=${dia}`).catch((err) => {
