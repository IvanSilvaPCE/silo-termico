   ...
   <div>
      <b-row>
         ...
         <b-col cols="5" class="text-right">
            ...
            <b-button variant="outline-primary" size="sm" v-b-tooltip.hover title="Ver log de eventos" @click="verLog(idArmazem)"><b-icon-clock></b-icon-clock></b-button>
         </b-col>
      </b-row>
      <b-row>
         <b-col>
...
export default {
   ...
   methods: {
      async buscar() {
         ...
         const dados = await client.get(`/armazem/buscaralarme/${this.idArmazem}?dia=${dia}`).catch((err) => {
