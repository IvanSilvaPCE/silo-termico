   ...
   methods: {
      construirGraficoInventario() {
         ...
         this.graficoInventario = {
            ...
            grid: { left: '1%', right: '1%', bottom: '1%', top: '13%', containLabel: true },
            tooltip: {
               trigger: 'axis',
               formatter: (params) => {
            ...
            series: series
            // series: [{ name: 'Capacidade utilizada', data: this.inventario.nivel, type: 'line', yAxisIndex: 0, smooth: true, showSymbol: false }]
         }
